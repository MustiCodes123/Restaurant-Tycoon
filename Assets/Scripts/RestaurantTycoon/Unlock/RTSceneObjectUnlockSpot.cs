...
{
    /// <summary>
    /// Physical unlock spot for RTSceneObjectUnlock.
    /// Player walks in, money drains, linked GameObjects activate on completion.
    /// </summary>
    public class RTSceneObjectUnlockSpot : MonoBehaviour
    {
        [Header("Detection")]
        ...
        // ── Runtime ───────────────────────────────────────────────────────────
        private RTSceneObjectUnlock sceneUnlock;
        ...
        private void Update()
        {
            if (!isPlayerInRange || !isPaymentActive || sceneUnlock == null) return;
        ...
        public void Show(RTSceneObjectUnlock unlock)
        {
            ...
            if (unlockNameText != null && unlock.UnlockData != null)
                unlockNameText.text = unlock.UnlockData.UnlockName;
        ...
        {
            if (sceneUnlock == null || CurrencyManager.Instance == null) return;
